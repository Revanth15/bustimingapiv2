...
async def get_transit_route_full(request: Request, body: TransitRouteRequest):
    """
    ...
    try:
        ...
        emit_route_http_error(
            ...
            has_time=bool(body.time),
            **redact_coordinates(body.start_lat, body.start_lon, body.end_lat, body.end_lon),
        )
        raise
...
async def get_transit_route(request: Request, body: TransitRouteRequest):
    """
